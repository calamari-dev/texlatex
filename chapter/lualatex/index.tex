...
\termdef{PGFPlots}\index{pgfplots@PGFPlots}は，\TikZ を利用してデータを可視化するパッケージである．
...
\LaTeX 文書に次の記述を加える．すると，\cref{figure:gnuplot}のグラフが得られる．
