...
\termdef{\upTeX}\index{uptex@\upTeX}はUnicodeの文字集合に属する日中韓の文字を扱える．
...
というソフトウェアがインストールされている．TeXworksを利用すると，\TeX ファイルの編集と\TeX エンジンの起動をGUIで行える．

また，本書はLaTeX Workshop\index{latexworkshop@LaTeX Workshop}\footnote{\url{https://github.com/James-Yu/LaTeX-Workshop}}と
